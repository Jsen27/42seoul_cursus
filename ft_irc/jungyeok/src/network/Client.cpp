...
void
Client::set_state(ClientState state) {
	_state = state;
}

void
Client::set_channel(Channel *channel) {
	_channel = channel;
}
...
void
Client::write(const std::string& message) const {
...
void
Client::reply(const std::string& reply) {
